...
public class sonarSystem extends Subsystem {
    ...
    private final static AnalogInput frontSonar = RobotMap.sonarSystemfrontSonar;
	...
	public float getRange(){
        float in = (float) ((frontSonar.getVoltage()*1000)/VOLTS_TO_DIST);
        SmartDashboard.putNumber("Distance (volts)", frontSonar.getVoltage());
        SmartDashboard.putNumber("Distance (real)", getDistance());
        return in;
    }
    public static double getDistance() {
        return frontSonar.getVoltage() * VOLTS_TO_DIST;
    }
