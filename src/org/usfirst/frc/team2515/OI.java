...
public class OI {
    ...
    public OI() {
        ...
        joystickLowerLiftButton.whileHeld(new pidLiftManual(-10));
        joystickRaiseLiftButton = new JoystickButton(joystick, 4);
        joystickRaiseLiftButton.whileHeld(new pidLiftManual(10));
        joystickLiftBottomButton = new JoystickButton(joystick, 11);
        joystickLiftBottomButton.whenPressed(new pidControlLift(0));
        joystickLiftMiddleButton = new JoystickButton(joystick, 9);
        joystickLiftMiddleButton.whenPressed(new pidControlLift(2400));
        joystickLiftTopButton = new JoystickButton(joystick, 7);
        joystickLiftTopButton.whenPressed(new pidControlLift(0));
        ...
        SmartDashboard.putData("pidControlLift: top", new pidControlLift(5000));
        SmartDashboard.putData("pidControlLift: middle", new pidControlLift(2400));
        SmartDashboard.putData("pidControlLift: bottom", new pidControlLift(0));
        SmartDashboard.putData("climbUp", new climbUp());
        SmartDashboard.putData("pidLiftManual: up", new pidLiftManual(10));
        SmartDashboard.putData("pidLiftManual: down", new pidLiftManual(-10));
